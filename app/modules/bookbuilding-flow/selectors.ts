...
export const selectBookbuildingStats = (
  state: IAppState,
  etoId: string,
): bookbuildingStatsInterfaces.IBlBookBuildingStats =>
  convert(
    state.bookBuildingFlow.bookbuildingStats[etoId],
    bookbuildingStatsInterfaces.stateToBlConversionSpec,
  );

export const selectMyPledge = (
  state: IAppState,
  etoId: string,
): pledgeInterfaces.IBlPledge | undefined =>
