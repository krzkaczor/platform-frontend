...
export const selectTxSummaryData = (
  state: IAppState,
): Partial<txDataInterfaces.IBlTxData> | txDataInterfaces.IBlTxData | undefined =>
  (state.txSender.summaryData &&
    convert(state.txSender.summaryData.txData, txDataInterfaces.stateToBlConversionSpec)) ||
  convert(state.txSender.txDetails, txDataInterfaces.stateToBlConversionSpec);
