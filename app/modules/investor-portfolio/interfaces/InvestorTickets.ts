...
export interface IStateInvestorTickets {
  ...
  calculatedContributions: Dictionary<
    calculatedContributionInterfaces.IStateCalculatedContribution | undefined
  >;
  initialCalculatedContributions: Dictionary<
    calculatedContributionInterfaces.IStateCalculatedContribution | undefined
  >;
...
export interface IBlInvestorTickets {
  ...
  calculatedContributions: Dictionary<
    calculatedContributionInterfaces.IBlCalculatedContribution | undefined
  >;
  initialCalculatedContributions: Dictionary<
    calculatedContributionInterfaces.IBlCalculatedContribution | undefined
  >;
